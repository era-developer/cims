...
fs.writeFileSync(sw, fs.readFileSync(sw, 'utf8').replace("const CACHE_VERSION = 'cims-v1';", `const CACHE_VERSION = 'cims-${hash}';`));
console.log(`sw.js cache version -> cims-${hash}`);
