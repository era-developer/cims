...
// change; the defaults are Kalam Pragati's.
//
...
export const ORG_NAME = env('REACT_APP_ORG_NAME', 'Kalam Pragati');
export const APP_SHORT_NAME = env('REACT_APP_APP_SHORT_NAME', 'KIMS');
export const APP_SUBTITLE = env('REACT_APP_ORG_TAGLINE', 'Empowering Engineers with Skills for Success');
...
// Deep navy from the Kalam Pragati wordmark.
export const PRIMARY_COLOR = env('REACT_APP_PRIMARY_COLOR', '#2d2a6e');
