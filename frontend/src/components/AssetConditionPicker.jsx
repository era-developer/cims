...
// The admin picks exactly which tag came back in which condition, instead of
// the backend guessing which of the "first N issued" units to mark damaged.
// Scanning is handled once per return by <ReturnScanner>, not per component.
const OPTIONS = [
